#!/bin/zsh
# Signs the current HAP for the registered HarmonyOS debugging device.
# Passwords are only read interactively and are never stored or displayed.
set -euo pipefail
...
CERTIFICATE="$PROJECT_DIR/HarmonySign/xiangyin_map_debug_chain.cer"
PROFILE="$PROJECT_DIR/HarmonySign/乡音Debug.p7b"
INPUT="$PROJECT_DIR/entry/build/default/outputs/default/entry-default-unsigned.hap"
OUTPUT="$PROJECT_DIR/entry/build/default/outputs/default/entry-default-debug-signed.hap"
VERIFY_CERT_CHAIN="$PROJECT_DIR/entry/build/default/outputs/default/entry-default-debug-signed-cert-chain.cer"
VERIFY_PROFILE="$PROJECT_DIR/entry/build/default/outputs/default/entry-default-debug-signed-profile.p7b"
